        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FileExtenstion = table.Column<string>(nullable: true),
                    OwnerId = table.Column<string>(nullable: true),
                    AttachmentOwner = table.Column<byte>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TablePkId = table.Column<long>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiredDetail = table.Column<string>(nullable: false),
                    Recommendation = table.Column<string>(nullable: false),
                    StatusOfAcievement = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nationality1 = table.Column<int>(nullable: true),
                    Country = table.Column<int>(nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Discriminator", "Name", "NormalizedName" },
                values: new object[] { "2", null, "ApplicationRole", "Customer", "CUSTOMER" });
